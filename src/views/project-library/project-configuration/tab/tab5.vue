<template>
  <div class="h100 border-d9 border-radius-5">
    ...
    <el-dialog title="查看使用事件模板" :visible.sync="dialogFormVisible" :modal-append-to-body="false" :close-on-click-modal="false" width="826px">
...
export default {
  ...
  methods: {
    ...
    edit(params) {
      this.$router.push({ path: '/project-library/project-configuration/model-edit-template', query: { projectName: getUrlParams().projectName, from: '使用事件', modelName: params.modelName, modelDesc: params.modelDesc }})
    }
  }
